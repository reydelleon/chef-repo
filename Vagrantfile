...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "reydelleon-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/daida"
  #   chef.validation_client_name = "daida-validator"
  #   chef.validation_key_path = ".chef/daida-validator.pem"
  # end
end
